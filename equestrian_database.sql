...
BEGIN
	DECLARE v_horse_id VARCHAR(255);
        ...
        IF v_horse_exists THEN
	        ...
	        ELSE
                        INSERT INTO financials (horse_id, type, amount, description) VALUES (v_horse_id, p_type, p_amount, p_description);
                        IF p_type = 'spending' THEN UPDATE horses SET spendings = spendings + p_amount WHERE horse_id = v_horse_id;
...
BEGIN
        ...
        IF v_barn_available THEN
                INSERT INTO horses (horse_id, name, gender, birth_year, status, barn_id) VALUES (p_horse_id, p_horse_name, p_gender, p_birth_year, p_status, p_barn_id);
